...
from networks.common_func.attention_module import PAM_CAM_Layer
...
class MFNet50_v3(nn.Module):
    def __init__(self, in_c, num_class, pretrained_path='download', bilinear=True):
        ...
        self.fb = FusionBlock()
        self.pam_cam = PAM_CAM_Layer(256)
